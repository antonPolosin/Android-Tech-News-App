...
public class NoupeActivity extends AppCompatActivity {

    private static final String TAG = "NoupeActivity";

    URLS usedUrls = new URLS("https://www.noupe.com/", "https://www.noupe.com/feed");
    ...
    private void init(){
        ...
        call.enqueue(new Callback<RssFeed>() {
            ...
            public void onFailure(Call<RssFeed> call, Throwable t) {
                ...
                Toast.makeText(NoupeActivity.this, "The error occured", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
