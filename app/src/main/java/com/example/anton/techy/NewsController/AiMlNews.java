...
public class AiMlNews extends AppCompatActivity {
    ...
    private void init() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(UrlsList.getAiNews().get(0))
                //converter XML
        ...
        Call<RssFeed> call = feed.getFeed(UrlsList.getAiNews().get(1));
        ...
        retrofit = new Retrofit.Builder()
                .baseUrl(UrlsList.getAiNews().get(2))
                //converter XML
                .addConverterFactory(SimpleXmlConverterFactory.create())
                .build();
        ...
        call = feed.getFeed(UrlsList.getAiNews().get(3));
