...
public class IphoneBacksActivity extends AppCompatActivity{

    private static final String TAG = "IphoneBacks";

    URLS usedUrls = new URLS("http://www.iphonehacks.com/", "http://www.iphonehacks.com/feed");
    ...
    private void init(){
        ...
        call.enqueue(new Callback<RssFeed>() {
            ...
            public void onFailure(Call<RssFeed> call, Throwable t) {
                ...
                Toast.makeText(IphoneBacksActivity.this, "The error occured", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
