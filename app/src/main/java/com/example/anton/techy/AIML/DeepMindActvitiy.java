...
public class DeepMindActvitiy extends AppCompatActivity{

    private static final String TAG = "DeepMindActivity";

    URLS usedUrls = new URLS("https://deepmind.com/", "https://deepmind.com/blog/feed/basic/");
...
//                    List<String> postContent = extractVerge.start();
            ...
            public void onFailure(Call<RssFeed> call, Throwable t) {
                ...
                Toast.makeText(DeepMindActvitiy.this, "The error occured", Toast.LENGTH_SHORT).show();
            }
        });
    }
